<main>
    <div class="container">
        ...
        <table>
            ...
            <tr>
                <th>Mondo:</th>
                <td><a href="world.php?id=<?php echo $lint["Mondo"]?>#" class="aMondo"><?php echo $lint["NomeMondo"]?></a></td>
            </tr>
            <tr>
                <th>Stato:</th>
                <td><a href="state.php?name=<?php echo $lint["Stato"]?>&worldId=<?php echo $lint["Mondo"]?>#" class="aStato"><?php echo $lint["Stato"]?></a></td>
            </tr>
            <?php if(!empty($lint["appNome"])) {?>
            <tr>
                <th>Appartiene:</th>
                <td><a href="?id=<?php echo $lint["Appartiene"]?>#" class="aAppart"><?php echo $lint["appNome"]?></a></td>
            </tr>
            <?php }?>
        </table>
